...
switch($conf['type']){
  case 1:
  $query.="AND ((tblPacks.Flag_isTG)=0) AND (NOT(tblPacks.MPA_FHG)='') ";
    break;
  case 2:
  $query.="AND (((tblPacks.Flag_isTG)=1) OR (((tblPacks.Flag_isTG)=0) AND (NOT(tblPacks.MPA_PIC)=''))) ";
    break;
  case 3:
...
foreach ($galleryList as $gallery) {
  if(tubeFilter($gallery)){
    $tubeList[] = $gallery;
  }
}
$galleryList = $tubeList;
